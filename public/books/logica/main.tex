...
\begin{document}
  ...
  \textbf{moleculares}, y decimos que una proposición es verdadera $V$ bajo una
  \note[title=valuación]{La valuación $V$ es determinada por las reglas del modelo al que se aplica.} $v$
  ...
  \begin{minipage}{0.55\textwidth}
    \begin{definition}[title=Negación]
  ...
  \begin{proposition}
    ...
    \begin{proof}
      \begin{block}
        \item  En un espacio euclídeo, todo triángulo tiene $180°$, de modo que el tercer ángulo es $60°$ pues:
          \begin{align}
            x + 2(60) &= 180 \\
            x &= 60°
          \end{align}
        ...
        \item Si bien no se demuestra directamente la exclusión, se recurre a ella pues:
          \begin{align}
  ...
  Nótese que se está aplicando la
  \note[title=tautología como patrón]{ De esto se desprenden las reglas de inferencia.
    Aplicar este patrón permite construir una cadena de verdades.
  },
  de forma que puede sustituir o simplificar proposiciones previamente probadas.
  Este mecanismo fue usado por Euclides en sus libros "Elementos".
  ...
  Cuando una proposición se vuelve compleja, pueden aparecer casos en los que las negaciones
  agrupan a una o varias proposiciones moleculares de modo que su analisis puede complicarse
  puesto que se evalua todo el interior y finalmente se aplica la negacion. Sin embargo, veremos
  que hay ocasiones en las que ese agrupamiento no presenta un beneficio directo. Para ello
  tenemos disponibles algunas formas de expandir o distribuir esas negaciones.
  ...
  Es en este punto que podemos generalizar las proposiciones. Con esto podemos
  definir cadenas de proposiciones llamadas argumentos.
